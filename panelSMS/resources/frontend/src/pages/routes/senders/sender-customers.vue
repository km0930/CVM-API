              ...
              <table class="table">
                ...
                <tbody style="color: black;">
                  ...
                  <tr>
                    <td>Sender</td>
                    <td>
                      <v-autocomplete v-model="newSenderModel" label="Type of Sender" :items="getRouteTypes"
                        multiple></v-autocomplete>
                    </td>
                  </tr>
                  <tr>
              ...
              <table class="table">
                ...
                <tbody style="color: black;">
                  ...
                  <tr>
                    <td>Customer</td>
                    <td>
                      <v-autocomplete v-model="editCustomerModel" label="Type of Customer" :items="getcustomers"
                        multiple></v-autocomplete>
                    </td>
                  </tr>
                  <tr>
                    <td>Sender</td>
                    <td>
                      <v-autocomplete v-model="editSenderModel" label="Type of Sender" :items="getRouteTypes"
                        multiple></v-autocomplete>
                    </td>
                  </tr>
                  <tr>
