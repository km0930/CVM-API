<template>
  <VCol cols="12" md="12" lg="12">
    <VCard class="text-center py-4" title="Backup Customers">
      <v-divider></v-divider>
              ...
              <table class="table">
                ...
                <tbody style="color: black;">
                  ...
                  <tr>
                    <td>Customer</td>
                    <td>
                      <v-autocomplete v-model="newCustomerModel" label="Customer" :items="getRouteTypes"
                        multiple></v-autocomplete>
                    </td>
                  </tr>
                  <tr>
              ...
              <table class="table">
                ...
                <tbody style="color: black;">
                  ...
                  <tr>
                    <td>Customer</td>
                    <td>
                      <v-autocomplete v-model="editCustomerModel" label="Customer" :items="getRouteTypes"
                        multiple></v-autocomplete>
                    </td>
                  </tr>
                  <tr>
...
export default {
  ...
  computed: {
    ...mapGetters(['GetRoutingBackupCustomersData', 'IsLoading',]),
    getCountries: function () {
      return this.GetRoutingBackupCustomersData?.countryList?.map(item => {
        return {
          code: item.code,
          state: item.state,
    ...
    getRouteTypes: function () {
      return this.GetRoutingBackupCustomersData?.routeList?.map(item => `${item.route} [${item.id}]`).splice(0, 50);
    },
    getCustomers: function () {
      const customerList = this.GetRoutingBackupCustomersData?.customerList;
  ...
  mounted() {
    ...
    this.fetchRoutingBackupCustomersData({
    }).then(() => {
      this.connectionData = this.GetRoutingBackupCustomersData?.data;
    });
  },
  methods: {
    ...mapActions(['fetchRoutingBackupCustomersData',]),
    search() {
