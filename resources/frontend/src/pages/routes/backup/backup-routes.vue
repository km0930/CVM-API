              ...
              <table class="table">
                ...
                <tbody style="color: black;">
                  ...
                  <tr>
                    <td>Fail Route</td>
                    <td>
                      <v-autocomplete v-model="newFailRouteModel" label="Fail Route" :items="getRouteTypes"
                        multiple></v-autocomplete>
                    </td>
                  </tr>
                  <tr>
              ...
              <table class="table">
                ...
                <tbody style="color: black;">
                  ...
                  <tr>
                    <td>Fail Route</td>
                    <td>
                      <v-autocomplete v-model="editFailRouteModel" label="Fail Route" :items="getRouteTypes"
                        multiple></v-autocomplete>
                    </td>
                  </tr>
                  <tr>
