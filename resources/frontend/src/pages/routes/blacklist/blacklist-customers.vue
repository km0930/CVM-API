          ...
          <v-card>
            <v-card-title>
              <v-row align="center" justify="space-between">
                <v-col cols="auto">
                  <span class="headline">New BlackList</span>
                </v-col>
                <v-col cols="auto">
                  <v-btn icon>
              ...
              <table class="table">
                ...
                <tbody style="color: black;">
                  ...
                  <tr>
                    <td>Customer</td>
                    <td>
                      <v-autocomplete v-model="newRouteModel" label="Customer" :items="getRouteTypes" multiple></v-autocomplete>
                    </td>
                  </tr>
                  <tr>
                    <td>Sender</td>
              ...
              <table class="table">
                ...
                <tbody style="color: black;">
                  ...
                  <tr>
                    <td>Customer</td>
                    <td>
                      <v-autocomplete v-model="editRouteModel" label="Customer" :items="getRouteTypes" multiple></v-autocomplete>
                    </td>
                  </tr>
                  <tr>
                    <td>Sender</td>
