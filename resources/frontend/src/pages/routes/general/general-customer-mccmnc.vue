              ...
              <table class="table">
                ...
                <tbody style="color: black;">
                  ...
                  <tr>
                    <td>MccMcc</td>
                    <td>
                      <v-autocomplete label="MccMcc" :items="getCustomers" v-model="newCustomerModel" item-title="state"
                        item-value="code" chips closable-chips>
                        <template v-slot:chip="{ props, item }">
                          <v-chip v-bind="props" :prepend-avatar="item.raw.flag" :text="item.raw.state"></v-chip>
                        </template>
              ...
              <table class="table">
                ...
                <tbody style="color: black;">
                  ...
                  <tr>
                    <td>MccMcc</td>
                    <td>
                      <v-autocomplete label="MccMcc" :items="getCustomers" v-model="editMccModel" item-title="state"
                        item-value="code" chips closable-chips>
                        <template v-slot:chip="{ props, item }">
                          <v-chip v-bind="props" :prepend-avatar="item.raw.flag" :text="item.raw.state"></v-chip>
                        </template>
